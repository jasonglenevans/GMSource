...
import msc from '!raw-loader!./ff596dded81647d2b019fe9019e61962.wav';
import jump from '!raw-loader!./Jump.svg';
...
const defaultProject = translator => {
    ...
    return [{
        ...
        id: 'ff596dded81647d2b019fe9019e61962',
        assetType: 'Sound',
        dataFormat: 'WAV',
        data: new Uint8Array(msc)
    }];
};
