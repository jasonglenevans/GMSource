...
class VirtualMachine extends EventEmitter {
    ...
    start () {
        this.runtime.start();
		console.warn("[gvbvdxx mod vm]: you are using start directley from the vm, its better if you call it from the runtime, you won't get this message.")
    }
    ...
    // @deprecated
    attachV2SVGAdapter () {
		console.warn("[gvbvdxx mod vm]: this function called 'attachV2SVGAdapter' is deprecated, please update to 'attachV2BitmapAdapter'")
    }
